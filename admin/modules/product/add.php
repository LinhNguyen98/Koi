                        ...
                        <div class="col-md-12">
                            <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="inputEmail3" class="control-label col-sm-2" >Danh mục sản phẩm</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="control-label col-sm-2" >Tên sản phẩm:</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="control-label col-sm-2" >Giá sản phẩm:</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="control-label col-sm-2" >Số lượng:</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <!-- <label for="inputEmail3" class="control-label col-sm-2" >Giảm giá:</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="control-label col-sm-2" >Nội dung</label>
                                    <div class="col-sm-8">
