...
<head>
    ...
    <!-- Bootstrap core CSS     -->
    <link href="/koi/Public/admin/css/bootstrap.min.css" rel="stylesheet" />

    <!-- Animation library for notifications   -->
    <link href="/koi/Public/admin/css/animate.min.css" rel="stylesheet"/>

    <!--  Light Bootstrap Table core CSS    -->
    <link href="/koi/Public/admin/css/light-bootstrap-dashboard.css?v=1.4.0" rel="stylesheet"/>


    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link href="/koi/Public/admin/css/demo.css" rel="stylesheet" />


    <!--     Fonts and icons     -->
    <link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Roboto:400,700,300' rel='stylesheet' type='text/css'>
    <link href="/koi/Public/admin/css/pe-icon-7-stroke.css" rel="stylesheet" />
    ...
    -->
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="<?php  echo isset($open) && $open == 'map' ? 'active' : '' ?>">
                    <a href="<?php echo modules("map")?>">
